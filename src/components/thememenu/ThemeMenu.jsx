...
const ThemeMenu = () => {
   ...
   const activeMenu = () => menu_ref.current.classList.add('active')
   ...
   useEffect(() => {
      ...
      localStorage.setItem("themeColor", "theme-color-blue")
   }, [])

   return (
      <div>
         <button ref={menu_toggle_ref} className="dropdown__toggle" onClick={()=>activeMenu} >
